...
public enum IPlayHubMessages {
    ...
    no_hub_in_world(ChatColor.RED + "There is no Hub in " + ChatColor.GOLD + "%s" + ChatColor.RED + " !"),
    no_teleport_points(ChatColor.RED + "There are no teleport positions available for you!"),
    hub_created(ChatColor.GREEN + "Hub in world " + ChatColor.GOLD + "%s" + ChatColor.GREEN + " successfully created!"),
